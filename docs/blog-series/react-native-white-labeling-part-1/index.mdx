...
_See the full config in the sample repository: [`examples/acme-health/config/bot.config.ts`](https://github.com/atomicrobot/react-native-white-label-blog-sample-repo/tree/main/examples/acme-health/config/bot.config.ts)_
